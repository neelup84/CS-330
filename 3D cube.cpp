...
namespace
{
    const char* const WINDOW_TITLE = "Neelima Patnaik - 3D CUBE"; // Window title
    ...
    struct GLMesh
    {
        GLuint vao;         // The vertex array object, the vertex buffer objects
        GLuint vbos[2];  
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] = { -1.0, -1.0,  1.0,  255,   0,   0, 255,
